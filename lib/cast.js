...
function trySet(glance, key, state, remainingKeys, parentStack) {
    ...
    return new Promise(function (resolve, reject) {
        glance.set(fullKey, state[key]).then(resolve, function (reason) {
...
var setStrategies = [function url(state, urlLoadedHooks, urlChangingHooks, glance) {
    var url = state['$URL$'];
    if (url) {
        delete state['$URL$'];
    ...
    _createClass(Cast, [{
        ...
        value: function set(state) {
            ...
            return states.reduce(function (p1, state) {
                return p1.then(function () {
                    return _this.eachSetStrategy(state, _this.urlLoadedHooks, _this.urlChangingHooks, glance);
                });
            }, Promise.resolve()).then(function () {
                return _this.endHooks.reduce(function (p1, hook) {
                    return p1.then(function () {
                        return hook.call(new _glanceWebdriver2.default(glance));
                    });
                }, Promise.resolve());
            });
        }
        ...
        key: "eachSetStrategy",
        value: function eachSetStrategy(state, urlLoadedHooks, urlChangingHooks, glance) {
