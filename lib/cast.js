    ...
    return Object.keys(state).reduce(function (p1, key) {
        return p1.then(function () {
            if (cast.literalHooks[key]) {
                return Promise.resolve(cast.literalHooks[key](_this, key, state[key], context));
            } else {
        ...
        value: function apply(state) {
            ...
            return this.beforeAll.reduce(function (p1, func) {
                ...
                return states.reduce(function (p1, state) {
                    ...
                    return _this2.endHooks.reduce(function (p1, hook) {
                        return p1.then(function () {
                            return hook.call(new _glanceWebdriver2.default(_this2.glance));
                        });
                    }, Promise.resolve());
                });
            });
